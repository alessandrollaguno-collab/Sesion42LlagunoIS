<%-- 
    Document   : index
    Created on : 24/10/2025, 08:35:48 AM
    Author     : LENOVO
--%>

<html>
    <head>
        <title>Pagina  Llaguno Aplicacion WEB SOFTWARE JSP - MYSQL </title>
        <meta charset="UTF-8">
    ...
    <body style="background-color: #5cb85c">
        ...
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA LAGUNO </h4>
                <br>
            </center>  
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                ...
                                <li><i class="fa fa-envelope-o"></i>Alessandro Llaguno </li>
                            </ul>
                        </div>

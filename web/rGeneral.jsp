<%-- 
    Document   : rGeneral
    Created on : 24/10/2025, 09:05:42 AM
    Author     : LENOVO
--%>

<html>
    <head>
        <title>Pagina Registro Llaguno Aplicacion WEB SOFTWARE JSP - MYSQL </title>
        <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="order-details">
                    <div class="row"><!--Inicia fila-->
                        <form method="post" action="rAlumno1.jsp">
                            <div class="row">
                                <center>
                                    <h3>ALTA USUARIO LLAGUNO</h3>
